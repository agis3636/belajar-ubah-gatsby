            ...
            <div className="container">
                <div className="col">
                    <Link to="/blog" style={{textDecoration: `none`}}>
                        <div className="card">
                            <div className="title">
                                <h2 id="tech">Klik</h2><h2 id="blog"> Disini</h2>
                            </div>
                            <p id="tblink">Untuk masuk ke halaman Blog</p>
                        </div>
                    </Link>
                </div>
                <div className="col">
                    <a href="https://www.facebook.com/muhamad.agis/" style={{textDecoration: `none`, color: `rebeccapurple`}} target="_blank">
                        <div className="card">
